AC_DEFUN([BEGINNERCOIN_FIND_BDB48],[
  ...
  if test "x$bdbpath" = "xX"; then
    ...
    BEGINNERCOIN_SUBDIR_TO_INCLUDE(BDB_CPPFLAGS,[${bdbpath}],db_cxx)
    ...
    BEGINNERCOIN_SUBDIR_TO_INCLUDE(BDB_CPPFLAGS,[${bdb48path}],db_cxx)
    bdbpath="${bdb48path}"
  fi
