...
#ifndef BEGINNERCOIN_CORE_H
#define BEGINNERCOIN_CORE_H
...
//DEVCOIN globals
static const int64_t initialSubsidy = 100*COIN ;
...
static const int64_t fallbackReduction = 0;
