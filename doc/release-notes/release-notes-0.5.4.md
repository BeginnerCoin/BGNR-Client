Beginnercoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/beginnercoin/files/Beginnercoin/beginnercoin-0.5.4/
...
http://gitorious.org/beginnercoin/beginnercoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Beginnercoin-Qt notifications under Growl 1.3.
Increase required age of Beginnercoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBeginnercoin properly when installing Beginnercoin-Qt over it. (Windows)
