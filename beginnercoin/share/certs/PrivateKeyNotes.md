...
unlocked to sign the Beginnercoin-Qt.app bundle.
...
allowing somebody to distribute a Beginnercoin-Qt.app or beginnercoin-qt-setup.exe with a valid
...
that the beginnercoin-qt.exe file inside the installer had not been tampered with.
