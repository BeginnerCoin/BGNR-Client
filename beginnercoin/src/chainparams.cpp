...
public:
    CMainParams() {
        ...
        genesis.nNonce   = 2903500320;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000000f0ea1e1097b1e0f6d9b2fc3870cb0b521b30734fb375366beb122337"));
        assert(genesis.hashMerkleRoot == uint256("0xaf9814db4682e435f49fd7f7bf8d97050a7f3de0277943489955fa30ca4c3936"));
