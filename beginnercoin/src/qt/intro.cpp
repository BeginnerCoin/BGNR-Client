...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/beginnercoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Beginnercoin"),
     ...
     * override -datadir in the beginnercoin.conf file in the default data directory
     * (to be consistent with beginnercoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
