...
{
    BOOST_CHECK(TestSplitHost("www.beginnercoin.org", "www.beginnercoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.beginnercoin.org]", "www.beginnercoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.beginnercoin.org:80", "www.beginnercoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.beginnercoin.org]:80", "www.beginnercoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:9844", "127.0.0.1", 9844));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:9844", "127.0.0.1", 9844));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:9844", "::ffff:127.0.0.1", 9844));
    BOOST_CHECK(TestSplitHost("[::]:9844", "::", 9844));
    BOOST_CHECK(TestSplitHost("::9844", "::9844", -1));
    BOOST_CHECK(TestSplitHost(":9844", "", 9844));
    BOOST_CHECK(TestSplitHost("[]:9844", "", 9844));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:9844", "127.0.0.1:9844"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:9844", "[::]:9844"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
