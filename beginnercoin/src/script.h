...
#ifndef H_BEGINNERCOIN_SCRIPT
#define H_BEGINNERCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CBeginnercoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Beginnercoin always counted CHECKMULTISIGs
