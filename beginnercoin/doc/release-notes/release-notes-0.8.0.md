Beginnercoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/beginnercoin/files/Beginnercoin/beginnercoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Beginnercoin
...
New/changed settings (command-line or beginnercoin.conf file)
--------------------------------------------------------
