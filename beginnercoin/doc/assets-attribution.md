The following is a list of assets used in the beginnercoin source and their proper attribution.
...
* License: MIT
* Site: [https://beginnercointalk.org/index.php?topic=15276.0](https://beginnercointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original beginnercoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/beginnercoin.icns, src/qt/res/src/beginnercoin.svg,
	src/qt/res/src/beginnercoin.ico, src/qt/res/src/beginnercoin.png,
	src/qt/res/src/beginnercoin_testnet.png, docs/beginnercoin_logo_doxygen.png,
