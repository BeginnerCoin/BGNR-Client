Beginnercoin Core version 0.9.2 is now available from:

  https://beginnercoin.org/bin/0.9.2/
...
installer (on Windows) or just copy over /Applications/Beginnercoin-Qt (on Mac) or
beginnercoind/beginnercoin-qt (on Linux).
...
- Lower paytxfee warning threshold from 0.25 BGNR to 0.01 BGNR
...
- Fix "Start beginnercoin on system login"
