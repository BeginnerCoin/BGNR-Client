...
*Setup instructions for a gitian build of Beginnercoin using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Beginnercoin
...
- [Building Beginnercoin](#building-beginnercoin)
...
Clone the git repositories for beginnercoin and gitian,

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/beginnercoin/beginnercoin
```
...
In [doc/release-process.md](release-process.md) in the beginnercoin repository under 'Fetch and build inputs'.
...
Building Beginnercoin
----------------

To build Beginnercoin (for Linux and/or Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the beginnercoin repository.

Output from `gbuild` will look something like

    Initialized empty Git repository in /home/debian/gitian-builder/inputs/beginnercoin/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/beginnercoin/beginnercoin
...
For example:
```bash
URL=https://github.com/laanwj/beginnercoin.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit beginnercoin=${COMMIT} --url beginnercoin=${URL} ../beginnercoin/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit beginnercoin=${COMMIT} --url beginnercoin=${URL} ../beginnercoin/contrib/gitian-descriptors/gitian-win.yml
```
...
```bash
    gpg --detach-sign ${VERSION}/${SIGNER}/beginnercoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/beginnercoin-build.assert
```
...
[beginnercoin/gitian.sigs](https://github.com/beginnercoin/gitian.sigs/) repository, or
