#!/usr/bin/python
# Copyright (c) 2013 The Beginnercoin Core developers
...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old BeginnercoinPullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/BeginnercoindComparisonTool_jar/BeginnercoindComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/beginnercoin/beginnercoin.git")
...
environ_default("BUILD_PATH", "/mnt/beginnercoin")
...
environ_default("GITHUB_REPO", "beginnercoin/beginnercoin")
