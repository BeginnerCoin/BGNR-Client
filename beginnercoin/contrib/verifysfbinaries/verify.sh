...
WORKINGDIR="/tmp/beginnercoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/beginnercoin/Beginnercoin/beginnercoin-0.9.0rc1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/beginnercoin/Beginnercoin/"
VERSIONPREFIX="beginnercoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'beginnercoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[beginnercoin-]<version>-[rc[0-9]] (example: beginnercoin-0.7.1-rc1)"
   echo "wget output:"
